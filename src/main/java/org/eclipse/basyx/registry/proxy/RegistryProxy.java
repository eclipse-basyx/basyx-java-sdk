 ...
 *
 */
public class RegistryProxy extends VABRegistryProxy implements IRegistry {
	 ...
	 */
	public RegistryProxy(String registryUrl) {
	 ...
	 */
	public RegistryProxy(IModelProvider provider) throws ProviderException {
